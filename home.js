...
const greetUser = usernmae => {
    return `Welcome back, ${usernmae}`
}

// console.log(greetUser('Andrew')) //checks to see if greetUser returns anything
...
const canWeDeliver = (zipCode) => {
    ...
    for (let i = 0; i < deliveryAreaZipCodes.length; i++){
        // console.log(zipCode, deliveryAreaZipCodes[i]) // logs each zipcode
...
// console.log(deals[0].title) // returns 10% off
...
// console.log(deals) // reflects 10%, April, and whitespace changes on the full object